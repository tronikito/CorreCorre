...
public class Chicken implements Weapon {
    ...
    public Chicken(Block old) {
        ...
        this.weaponType = "heightScreenicken";
        this.speedBullet = new int[] {xBulletSpeed,0};

        this.pos1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.w_metralletagallinaleft,null);
        this.pos2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.w_metralletagallinaright,null);
        this.empty = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_empty,null);
        this.d = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.w_metralletagallina,null);
    }
