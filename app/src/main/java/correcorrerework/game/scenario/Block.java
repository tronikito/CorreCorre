...
public class Block extends BlockSprites {
    ...
    public synchronized void setType(String type, String typeOf) {
        ...
        if (type.equals("enemy")) {
            ...
            blockSprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_empty, null);
        }
...
/*
    public synchronized void setBlockType(String blockType) {
        ...
        if (blockType.equals("dirt")) {
            if (sprite == 1) sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_dirt1, null);
            if (sprite == 2) sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_dirt2, null);
            if (sprite == 3) sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_dirt3, null);
        }
        if (blockType.equals("void")) {
            sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_voidstone1, null);
            sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_voidstone2, null);
            sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_voidstone3, null);
            sprite4 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_voidstone4, null);
            sprite5 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_voidstone5, null);
        }
        if (blockType.equals("stone")) {
            if (sprite == 1) sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone1, null);
            if (sprite == 2) sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone2, null);
            if (sprite == 3) sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone3, null);
            if (sprite == 4) sprite4 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone4, null);
            if (sprite == 5) sprite5 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone5, null);
            if (sprite == 6) sprite6 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone6, null);
            if (sprite == 7) sprite7 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone7, null);
            if (sprite == 8) sprite8 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone8, null);
            if (sprite == 9) sprite9 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone9, null);
            if (sprite == 10) sprite10 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone10, null);
            if (sprite == 11) sprite11 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone11, null);
            if (sprite == 12) sprite12 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone12, null);
            if (sprite == 13) sprite13 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone13, null);
            if (sprite == 14) sprite14 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_stone14, null);
        }
        if (blockType.equals("grass")) {
            sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_newgrass1, null);
            sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_newgrass2, null);
            sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_newgrass3, null);
            sprite4 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_newgrass5, null);
            sprite5 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_newgrass6, null);
        }
        if (blockType.equals("red")) {
            sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_red, null);
        }
        if (blockType.equals("blue")) {
            sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_blue, null);
        }
        if (blockType.equals("sapphire")) {
            if (sprite == 1) sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_sapphire1, null);
            if (sprite == 2) sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_sapphire2, null);
            if (sprite == 3) sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_sapphire3, null);;
        }
        if (blockType.equals("gold")) {
            if (sprite == 1) sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_gold1, null);
            if (sprite == 2) sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_gold2, null);
            if (sprite == 3) sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_gold3, null);
        }
        if (blockType.equals("redstone")) {
            if (sprite == 1) sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_redstone1, null);
            if (sprite == 2) sprite2 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_redstone2, null);
            if (sprite == 3) sprite3 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_redstone3, null);
        }
        if (blockType.equals("empty")) {
            sprite1 = VectorDrawableCompat.create(mactivity.getResources(), R.drawable.c_empty, null);
        }
        setSprite(sprite);
